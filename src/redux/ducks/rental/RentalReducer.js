...
export default (state = INIT_STATE, action) => {
  switch (action.type) {
    ...
    case types.CREATE_RENTAL_CAR_SUCCESS:
        NotificationManager.success("Rental car created");
        let cars = [...state.list];
    ...
    case types.UPDATE_RENTAL_CATEGORY_FAILURE:
    ...
    case types.DELETE_RENTAL_CATEGORY_SUCCESS:
      ...
      const deleteCat = Object.assign([], state.categories).filter(
        rent => rent.id != action.payload
      );
