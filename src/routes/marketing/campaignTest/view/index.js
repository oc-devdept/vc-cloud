                  ...
                  <ProfileTabs>
                    ...
                    <div label="Template">
                      <iframe
                        ...
                        src={
                          ...
                          encodeURIComponent(data.htmlContent)
                        }
                      ></iframe>
                    </div>
                    ...
                    {/* <TableContainer component={Paper}> */}
                      <Table size="small" aria-label="a dense table">
                        ...
                        <TableBody>
                        {stat.deliveredArray && stat.deliveredArray.map((row) => (
                    ...
                    {/* <TableContainer component={Paper}> */}
                      <Table size="small" aria-label="a dense table">
                        ...
                        <TableBody>
                        {stat.failedArray && stat.failedArray.map((row) => (
                           <TableRow key={row.recipient}>
                           <TableCell component="th" scope="row">
                             {row.recipient}
                           </TableCell>
                   ...
                   {/* <TableContainer component={Paper}> */}
                      <Table size="small" aria-label="a dense table">
                        ...
                        <TableBody>
                        {stat.viewedArray && stat.viewedArray.map((row) => (
                            <TableRow key={row.recipient}>
                            <TableCell component="th" scope="row">
                              {row.recipient}
                            </TableCell>
                    ...
                    {/* </TableContainer> */}
                     ...
                     {/* <TableContainer component={Paper}> */}
                      <Table size="small" aria-label="a dense table">
                        ...
                        <TableBody>
                        {stat.clickedArray && stat.clickedArray.map((row) => (
                            <TableRow key={row.recipient}>
                            <TableCell component="th" scope="row">
                              {row.recipient}
                            </TableCell>
