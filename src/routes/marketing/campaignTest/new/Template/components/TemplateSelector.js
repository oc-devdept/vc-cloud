...
class TemplateSelector extends Component {
  ...
  showEditTemplate = (template, title, key) => {
    this.props.show("template_new_form", {
      onSave: (data) => { this.props.updateTemplate(data); this.props.onChange(data); },
  ...
  showEditContent = (template, onSave, key) => {
    this.props.show("template_form", {
      onSave: (data) => { this.props.updateEmailContent(data.id, data.html, data.design); this.props.onChange(data); },
      ...
      <React.Fragment >
        <div className="row justify-content-center mb-30">
            ...
            adminTemplateList.map((template, key) => (
              <div key={"shared" + key} className="col-4 mb-15">
                <Card onClick={() => {
                  ...
                  <CardActionArea
                    style={{ backgroundColor: this.state.selected === "shared" + key ? '#0c2041' : 'white' }}
                  >
                    ...
                    <CardMedia>
                      ...
                      <div style={{ position: "absolute", width: "100%", height: "100%", top: 0 }} onClick={() => {
                        this.showSelected("shared" + key, template)
                      }}></div>
                    </CardMedia>
                    <CardActions>
                  ...
                  <div className="col-md-4 ">
                    <Button
                      ...
                      onClick={() => this.showEditContent(template, onChange, "shared" + key)}
                      className="ml-20 mt-50   btn-success text-white"
                      variant="contained"
                      color="primary"
                    >
                      Content
          ...
          {templateList.map((template, key) => (
            <div key={"own" + key} className="col-4 mb-15">
              <Card onClick={() => {
                this.showSelected("own" + key, template)
              }}>
                <CardActionArea
                  style={{ backgroundColor: this.state.selected === "own" + key ? '#0c2041' : 'white' }}
                >
                  <div className="d-flex justify-content-end mt-30">
                  ...
                  <CardMedia>
                    ...
                    <div style={{ position: "absolute", width: "100%", height: "90%", top: "30px" }} onClick={() => {
                      this.showSelected("own" + key, template)
                    }}></div>
                  </CardMedia>
                  <CardActions>   <CardContent>
                    ...
                    <FormControlLabel
                      ...
                      style={{ paddingTop: "6px", marginLeft: "2px" }}
                      label={<Typography style={{ fontSize: "0.8125rem", color: "#FF8B19" }}>Share</Typography>}
                    />
                  </div> */}
                  </CardActions>
                  <div className="d-flex justify-content-around col-md-12">
                    ...
                    <div>
                      <FormControlLabel
                        ...
                        style={{ paddingTop: "6px", marginLeft: "2px", marginTop: "15px" }}
                        label={<Typography style={{ fontSize: "0.8125rem", color: "#595959" }}>Share</Typography>}
                        labelPlacement="top"
...
export default connect(null, { show, updateTemplate, addContent, deleteTemplate, addTemplate, updateEmailContent, updateTemplateTitle })(TemplateSelector);
