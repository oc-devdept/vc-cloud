  ...
  _submitPayment = e => {
    ...
    if (SubmitPaymentArray.length > 0) {
      ...
      if (paymentBalance.length > 0) {
        let messageContent =
          "You have opted to pay using existing balance(s) from previous payment, click OK to confirm or Cancel to return.";
        ...
        let messageContent =
          "No payment detected, please key in the amount and payment details to proceed";
        this.setState({
          message: true,
          messageTitle: "Payment Error",
          messageContent: messageContent,
          ...
          <form autoComplete="off">
            <FormInputLayout title="Key Information" desc="Payment information">
              <NewPayment
                ...
                _renderAllInvoicesForOneCompany={
                  this._renderAllInvoicesForOneCompany
                }
              />
            </FormInputLayout>
            ...
            {this.state.message && (
              ...
              >
                <div className="row">
                  <div className="col-md-12">{this.state.messageContent}</div>
