...
export default class Index extends PureComponent {
  ...
  render () {
    ...
    console.log(this.state.ModelSource)
    ...
    return (
      ...
      <div style={{border: '1px black solid', borderTop: 'none'}}>

        <div style={{flex: 1, display:'flex', justifyContent: 'flex-end'}}>
          <button onClick={()=> console.log('Toggle Tag Model Box!')} style={{color:'white', borderRadius: 5, padding: 8, backgroundColor:'rgba(24,59,129,1)', marginBottom: 10, marginTop: 20, marginRight: 20}}>{`+ ADD MODEL TO ${this.props.Make.toUpperCase()}`}</button>
        </div>
