    ...
    return (
        <div className="saas-dashboard">
            <Switch>
                ...
                <Route
                    exact
                    path={`${url.grapeJsPage}/bookCarServicing`}
                    component={async.cms_grapejs_book_car_servicing}
                />
                <Route
                    exact
                    path={`${url.grapeJsPage}/stepsArea`}
                    component={async.cms_grapejs_steps_area}
                />
