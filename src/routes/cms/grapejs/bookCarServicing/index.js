...
class GrapeJSBookCarServicing extends Component {
    ...
    return (
      ...
      <div className="gjs-logo-cont"></div>
        ...
        <section className="about-us-area">
              <div className="about-us-banner" style={{backgroundImage:  `url(${bookNowBannerImage})` }} />
              <div className="about-history" align="center">
                <h2>Sinzxcbsfce 2009</h2>
                <div className="row">
...
export default connect(mapStateToProps, { updateCmspage })(GrapeJSBookCarServicing);
/*
<section className="about-us-area">
