...
import grapesjsStep1 from 'Assets/img/grapejsStock/step1.png';
import grapesjsStep2 from 'Assets/img/grapejsStock/step2.png';
import grapesjsStep3 from 'Assets/img/grapejsStock/step3.png';
import grapesjsStep4 from 'Assets/img/grapejsStock/step4.png';
import grapesjsStep5 from 'Assets/img/grapejsStock/step5.png';
import grapesjsStep6 from 'Assets/img/grapejsStock/step6.png';
import grapesjsStep7 from 'Assets/img/grapejsStock/step7.png';
import grapesjsStep8 from 'Assets/img/grapejsStock/step8.png';

import { updateCmspage } from 'Ducks/cms/cmspage';


class GrapeJSStepsArea extends Component {
            ...
            <div className="container" >
                ...
                <div className="steps-row">
                  <div className="step text-center m-2 p-2">
                    <img className="stepIngs mb-3" src={grapesjsStep1}></img>
                    <h3 className="stepBubble text-center mb-3" >Step 1</h3>
                    <p className="text-center">Select your favourite car model</p>
                  </div>
                  <div className="step text-center m-2 p-2">
                    <img className="stepIngs mb-3" src={grapesjsStep2}></img>
                    <h3 className="stepBubble text-center mb-3" >Step 2</h3>
                    <p className="text-center">Customise your exterior & interior</p>
                  </div>
                  <div className="step text-center m-2 p-2">
                    <img className="stepIngs mb-3" src={grapesjsStep3}></img>
                    <h3 className="stepBubble text-center mb-3" >Step 3</h3>
                    <p className="text-center">Customise your wheels</p>
                  </div>
                </div>
                <div className="steps-row">
                  <div className="step text-center m-2 p-2">
                    <img className="stepIngs mb-3" src={grapesjsStep4}></img>
                    <h3 className="stepBubble text-center mb-3" >Step 4</h3>
                    <p className="text-center">Select your accessories</p>
                  </div>
                  <div className="step text-center m-2 p-2">
                    <img className="stepIngs mb-3" src={grapesjsStep5}></img>
                    <h3 className="stepBubble text-center mb-3" >Step 5</h3>
                    <p className="text-center">Select your COE package</p>
                  </div>
                  <div className="step text-center m-2 p-2">
                    <img className="stepIngs mb-3" src={grapesjsStep6}></img>
                    <h3 className="stepBubble text-center mb-3" >Step 6</h3>
                    <p className="text-center">Select your Aftersales Package</p>
                  </div>
                </div>
                <div className="steps-row justify-content-center ">
                   <div className="step text-center m-2 p-2">
                    <img className="stepIngs mb-3" src={grapesjsStep7}></img>
                    <h3 className="stepBubble text-center mb-3" >Step 7</h3>
                    <p className="text-center">Financing your car</p>
                  </div>
                  <div className="step text-center m-2 p-2">
                    <img className="stepIngs mb-3" src={grapesjsStep7}></img>
                    <h3 className="stepBubble text-center mb-3" >Step 8</h3>
                    <p className="text-center">Reserve your car</p>
                  </div>
                </div>
            </div>
...
export default connect(mapStateToProps, { updateCmspage })(GrapeJSStepsArea);
/*
